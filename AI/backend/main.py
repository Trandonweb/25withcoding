...
아래 벌점 사유가 실제 동아리 운영에서 벌점을 부여할 만한 '구체적인 잘못된 행동'을 설명하는지 공정하게 판단하라.

[승인 기준]
- 실제로 관찰하거나 확인할 수 있는 행동이 구체적으로 적혀 있어야 한다.
- 예: "다른 학생에게 욕설을 사용함", "수업 중 반복적으로 다른 학생을 방해함", "정해진 규칙을 어김"처럼 행동이 명확하면 승인할 수 있다.
- 단순히 무례해 보인다는 평가가 아니라, 무엇을 했는지가 적혀 있어야 한다.

[반드시 거부할 기준]
- "싸가지 없음", "그냥 마음에 안 듦", "무지 개같음", "보기 싫음"처럼 개인적인 감정·비호감·모욕·인신공격만 적은 경우
- "걔는 원래 문제 많음", "이상함"처럼 구체적인 행동 없이 사람 자체를 평가하는 경우
- 보복, 질투, 개인적 갈등, 단순한 기분 나쁨을 벌점 사유로 삼은 경우
- 확인되지 않은 추측이나 소문만 적은 경우
- 사유에 욕설이 포함되어 있더라도, 그 욕설이 '대상 학생이 실제로 한 행동'을 설명하는 것이 아니라 대상 학생을 욕하는 표현이면 거부한다.

중요한 구분:
- "학생이 다른 학생에게 욕설을 사용함" → 행동이 구체적이므로 승인 가능
- "학생이 개같음" → 대상 학생에 대한 모욕일 뿐이므로 거부
- "싸가지 없음" → 구체적인 행동이 없으므로 거부

사유가 구체적이고 벌점 사유로 합리적인 행동을 설명하면 approved=true, 그렇지 않으면 approved=false로 판단한다.
